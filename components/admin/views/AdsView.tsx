...
//             // Handle both new API (result.assets) and old API (result.uri)
...
//                 setSelectedImage({
//                     uri: legacy.uri,
//                     name: legacy.name ?? 'image',
//                     mimeType: legacy.mimeType ?? undefined,
//                     size: legacy.size ?? undefined,
//                 });
//             }
//         } catch (err) {
...
//             let imageUrl: string | null = editingAd?.image_url ?? null;
...
export function AdsView({ onBack }: AdsViewProps) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            let imageUrl: string | undefined = editingAd?.image_url ?? undefined;
