...
const styles = StyleSheet.create({
    ...
    actionsGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 12, marginBottom: 24, marginTop: 16 },
    actionBtn: { width: '47.2%', padding: 20, borderRadius: 24, alignItems: 'center', borderWidth: 1, elevation: 2, shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 10, position: 'relative', backgroundColor: '#FFFFFF', borderColor: '#D7CCC8' },
    actionIcon: { width: 56, height: 56, borderRadius: 18, alignItems: 'center', justifyContent: 'center', marginBottom: 14, backgroundColor: '#FFF8F6' },
    actionText: { fontSize: 12, fontWeight: '900', letterSpacing: 0.2, color: '#3E2723' },
    actionArrow: { position: 'absolute', top: 16, right: 16, color: '#D7CCC8' },
